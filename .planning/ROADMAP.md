...
- **Funcionalidades**:
  ...
  - Limite de tamanho máximo de arquivos e validação rígida de formato de arquivo (MIME-types) no backend.
  - Armazenamento físico e vínculo direto com os prontuários clínicos do paciente.
- **Depends on:** Phase 11.
...
### Phase 16B.1.2.1: Portal do Tutor (INSERTED)

**Goal:** [Urgent work - to be planned]
**Requirements**: TBD
**Depends on:** Phase 16B.1.2
**Plans:** 0 plans

Plans:

- [ ] TBD (run /gsd-plan-phase 16B.1.2.1 to break down)
