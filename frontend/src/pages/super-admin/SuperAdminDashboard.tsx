        ...
        <Card className="border-border bg-card/60 backdrop-blur-sm md:col-span-2 flex flex-col">
          ...
          <CardContent className="p-6 flex-1 grid grid-cols-2 sm:grid-cols-4 gap-6 items-center text-center">
            <div className="p-4 rounded-xl bg-card border border-border shadow-sm space-y-1.5">
              ...
              <span className="text-[10px] text-emerald-400 font-bold bg-emerald-500/10 px-1.5 py-0.5 rounded">Estável</span>
            </div>
            <div className="p-4 rounded-xl bg-card border border-border shadow-sm space-y-1.5">
            ...
            <div className="p-4 rounded-xl bg-card border border-border shadow-sm space-y-1.5">
              ...
              <span className="text-[10px] text-purple-300 font-bold bg-purple-500/10 px-1.5 py-0.5 rounded">Equilibrado</span>
            </div>
            <div className="p-4 rounded-xl bg-card border border-border shadow-sm space-y-1.5">
              ...
              <span className="text-[10px] text-emerald-300 font-bold bg-emerald-500/10 px-1.5 py-0.5 rounded">Verificado</span>
            </div>
          </CardContent>
        </Card>
