            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {item.failed > 0 && (
                    <div 
                      className="w-full bg-rose-500/75 group-hover:bg-rose-500 transition-colors"
                  ...
                  {item.sent > 0 && (
                    <div 
                      className="w-full bg-emerald-500/50 group-hover:bg-emerald-500 transition-colors"
