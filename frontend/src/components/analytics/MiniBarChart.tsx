        ...
        {data.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* Bar */}
              <div 
                className="w-full bg-primary/20 group-hover:bg-gradient-to-t group-hover:from-primary group-hover:to-violet-500 rounded-t-[3px] transition-all duration-300 relative overflow-hidden"
